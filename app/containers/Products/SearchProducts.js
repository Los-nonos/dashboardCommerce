...
class SearchProducts extends React.Component {
  ...
  handleLoadSearchProducts = () => {
    this.dispatch(searchActions.checkRoles());
    this.dispatch(searchActions.searchProducts(this.state, this.props.page, this.state.orderBy, this.state.order));
  }
...
export default connect(mapStateToProps)(withStyles(searchStyle)(SearchProducts));
